...
PyObject *ExtractorBaseTypeRprice::nb_add(PyObject *lhs, PyObject *rhs) {
  return ExtractorBaseTypeRprice::py_new(((ExtractorBaseTypeRprice *)lhs)->val + ((ExtractorBaseTypeRprice *)rhs)->val);
}
...
PyObject *ExtractorBaseTypeRprice::nb_true_divide(PyObject *self, PyObject *rhs) {
  return ExtractorBaseTypeRprice::py_new(((ExtractorBaseTypeRprice *)self)->val / ((ExtractorBaseTypeRprice *)rhs)->val);
}

PyObject *ExtractorBaseTypeRprice::nb_inplace_add(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRprice *)self)->val += ((ExtractorBaseTypeRprice *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRprice::nb_inplace_substract(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRprice *)self)->val -= ((ExtractorBaseTypeRprice *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRprice::nb_inplace_multiply(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRprice *)self)->val = ((ExtractorBaseTypeRprice *)self)->val * ((ExtractorBaseTypeRprice *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRprice::nb_inplace_true_divide(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRprice *)self)->val = ((ExtractorBaseTypeRprice *)self)->val / ((ExtractorBaseTypeRprice *)rhs)->val;
  Py_INCREF(self);
  return self;
}
...
PyNumberMethods ExtractorBaseTypeRprice::tp_as_number = {
  ...
  ExtractorBaseTypeRprice::nb_inplace_substract, //  binaryfunc nb_inplace_subtract;
  ExtractorBaseTypeRprice::nb_inplace_multiply, //  binaryfunc nb_inplace_multiply;
  ...
  ExtractorBaseTypeRprice::nb_inplace_true_divide, //  binaryfunc nb_inplace_true_divide;
...
PyMethodDef ExtractorBaseTypeRprice::tp_methods [] = {
  ...
  { "compare", (PyCFunction)ExtractorBaseTypeRprice::compare, METH_VARARGS|METH_KEYWORDS, NULL },
  ...
  // /* Miscellaneous */
  { "from_float", ExtractorBaseTypeRprice::from_float, METH_O|METH_CLASS, NULL },
...
PyObject *ExtractorBaseTypeRprice::tp_new(PyTypeObject *subtype,
...
PyObject *ExtractorBaseTypeRprice::py_richcmp(PyObject *obj1,
