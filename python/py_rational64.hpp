...
PyObject *ExtractorBaseTypeRational64::nb_add(PyObject *lhs, PyObject *rhs) {
  return ExtractorBaseTypeRational64::py_new(((ExtractorBaseTypeRational64 *)lhs)->val + ((ExtractorBaseTypeRational64 *)rhs)->val);
}

PyObject *ExtractorBaseTypeRational64::nb_substract(PyObject *lhs, PyObject *rhs) {
  return ExtractorBaseTypeRational64::py_new(((ExtractorBaseTypeRational64 *)lhs)->val - ((ExtractorBaseTypeRational64 *)rhs)->val);
}

PyObject *ExtractorBaseTypeRational64::nb_multiply(PyObject *lhs, PyObject *rhs) {
  return ExtractorBaseTypeRational64::py_new(((ExtractorBaseTypeRational64 *)lhs)->val * ((ExtractorBaseTypeRational64 *)rhs)->val);
}

PyObject *ExtractorBaseTypeRational64::nb_true_divide(PyObject *self, PyObject *rhs) {
  return ExtractorBaseTypeRational64::py_new(((ExtractorBaseTypeRational64 *)self)->val / ((ExtractorBaseTypeRational64 *)rhs)->val);
}

PyObject *ExtractorBaseTypeRational64::nb_inplace_add(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRational64 *)self)->val += ((ExtractorBaseTypeRational64 *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRational64::nb_inplace_substract(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRational64 *)self)->val -= ((ExtractorBaseTypeRational64 *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRational64::nb_inplace_multiply(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRational64 *)self)->val = ((ExtractorBaseTypeRational64 *)self)->val * ((ExtractorBaseTypeRational64 *)rhs)->val;
  Py_INCREF(self);
  return self;
}

PyObject *ExtractorBaseTypeRational64::nb_inplace_true_divide(PyObject *self, PyObject *rhs) {
  ((ExtractorBaseTypeRational64 *)self)->val = ((ExtractorBaseTypeRational64 *)self)->val / ((ExtractorBaseTypeRational64 *)rhs)->val;
  Py_INCREF(self);
  return self;
}
...
PyNumberMethods ExtractorBaseTypeRational64::tp_as_number = {
  ...
  ExtractorBaseTypeRational64::nb_inplace_substract, //  binaryfunc nb_inplace_subtract;
  ExtractorBaseTypeRational64::nb_inplace_multiply, //  binaryfunc nb_inplace_multiply;
  ...
  ExtractorBaseTypeRational64::nb_inplace_true_divide, //  binaryfunc nb_inplace_true_divide;
...
PyMethodDef ExtractorBaseTypeRational64::tp_methods [] = {
  ...
  { "compare", (PyCFunction)ExtractorBaseTypeRational64::compare, METH_VARARGS|METH_KEYWORDS, NULL },
  // { "compare_signal", _PyCFunction_CAST(dec_mpd_qcompare_signal), METH_VARARGS|METH_KEYWORDS, doc_compare_signal },
  { "max", ExtractorBaseTypeRational64::max, METH_VARARGS|METH_KEYWORDS, NULL },
  // { "max_mag", _PyCFunction_CAST(dec_mpd_qmax_mag), METH_VARARGS|METH_KEYWORDS, doc_max_mag },
  { "min", ExtractorBaseTypeRational64::min, METH_VARARGS|METH_KEYWORDS, NULL },
  ...
  { "is_infinite", ExtractorBaseTypeRational64::is_infinite, METH_NOARGS, NULL },
  ...
  // /* Miscellaneous */
  { "from_float", ExtractorBaseTypeRational64::from_float, METH_O|METH_CLASS, NULL },
...
bool ExtractorBaseTypeRational64::init(PyObject *m) {
  ...
  PyModule_AddObject(m, "Rational64", (PyObject *)&ExtractorBaseTypeRational64Type);
...
PyObject *ExtractorBaseTypeRational64::is_finite(PyObject *self, PyObject *args) {
  Py_RETURN_TRUE;
}

PyObject *ExtractorBaseTypeRational64::is_infinite(PyObject *self, PyObject *args) {
  Py_RETURN_FALSE;
}
...
PyObject *ExtractorBaseTypeRational64::is_signed(PyObject *self, PyObject *args) {
...
PyObject *ExtractorBaseTypeRational64::from_float(PyObject *type, PyObject *fval) {
