...
static struct extractor_api_v1 api_v1 {
  ...
  fm_data_get,
  fm_call_def_new,
  fm_call_def_init_set,
  fm_call_def_destroy_set,
  fm_call_def_exec_set,
  fm_ctx_def_new,
  fm_ctx_def_inplace_set,
  fm_ctx_def_type_set,
  fm_ctx_def_closure_set,
  fm_ctx_def_volatile_set,
