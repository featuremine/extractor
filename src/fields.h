...
#ifndef __FM_FIELDS_H__
#define __FM_FIELDS_H__

#include "extractor/arg_stack.h"
#include "extractor/comp_def.h"

fm_ctx_def_t *fm_comp_fields_gen(fm_comp_sys_t *sys, fm_comp_def_cl, unsigned,
                                 fm_type_decl_cp[], fm_type_decl_cp,
                                 fm_arg_stack_t);

void fm_comp_fields_destroy(fm_comp_def_cl, fm_ctx_def_t *);

const fm_comp_def_t fm_comp_fields = {"fields", &fm_comp_fields_gen,
                                      &fm_comp_fields_destroy, NULL};

#endif // __FM_FIELDS_H__
