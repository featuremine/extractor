...
#ifndef __FM_DIVIDE_H__
#define __FM_DIVIDE_H__

#include "arg_stack.h"
#include "comp_def.h"

fm_ctx_def_t *fm_comp_divide_gen(fm_comp_sys_t *sys, fm_comp_def_cl, unsigned,
                                 fm_type_decl_cp[], fm_type_decl_cp,
                                 fm_arg_stack_t);

void fm_comp_divide_destroy(fm_comp_def_cl, fm_ctx_def_t *);

const fm_comp_def_t fm_comp_divide = {"divide", &fm_comp_divide_gen,
                                      &fm_comp_divide_destroy, NULL};

#endif // __FM_DIVIDE_H__
