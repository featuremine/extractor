...
bool fm_comp_logical_and_call_stream_init(fm_frame_t *result, size_t args,
...
bool fm_comp_logical_and_stream_exec(fm_frame_t *result, size_t args,
                                     const fm_frame_t *const argv[],
...
fm_call_def *fm_comp_logical_and_stream_call(fm_comp_def_cl comp_cl,
                                             const fm_ctx_def_cl ctx_cl) {
  auto *def = fm_call_def_new();
  fm_call_def_init_set(def, fm_comp_logical_and_call_stream_init);
  fm_call_def_exec_set(def, fm_comp_logical_and_stream_exec);
  return def;
}

fm_ctx_def_t *fm_comp_logical_and_gen(fm_comp_sys_t *csys,
  ...
  fm_ctx_def_stream_call_set(def, &fm_comp_logical_and_stream_call);
  fm_ctx_def_query_call_set(def, nullptr);
  return def;
}

void fm_comp_logical_and_destroy(fm_comp_def_cl cl, fm_ctx_def_t *def) {
