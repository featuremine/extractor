 ...
 * @date 22 Aug 2018
 * @brief File contains C definitions of the "cond_unless" logical operator
 * object
 *
 * This file contains declarations of the "cond_unless" logical operator object
...
void fm_comp_filter_unless_destroy(fm_comp_def_cl, fm_ctx_def_t *);
