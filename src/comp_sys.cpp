...
static void
fm_comp_sys_ext_path_list_add(struct fm_comp_sys_ext_path_list **phead,
...
static void module_type_add_v1(struct fm_comp_sys_module *mod,
                               const fm_comp_def_t *def, fmc_error_t **error) {
  fmc_error_clear(error);
  fm_comp_type_add(mod->sys, def);
}

static void incompatible(struct fm_comp_sys_module *, void *,
                         fmc_error_t **error) {
  fmc_error_set(
      error,
      "extractor extension API version is higher than the system version");
}

static struct fm_comp_sys_ext_api api = {
    .module_type_add_v1 = module_type_add_v1,
    .module_type_add_v2 = incompatible,
    .module_type_add_v3 = incompatible,
    .module_type_add_v4 = incompatible,
    .module_type_add_v5 = incompatible,
    ._zeros = {NULL},
};
