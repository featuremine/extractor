...
FMMODFUNC fm_ctx_def_t *fm_comp_identity_gen(fm_comp_sys_t *sys, fm_comp_def_cl,
                                             unsigned, fm_type_decl_cp[],
                                             fm_type_decl_cp, fm_arg_stack_t);

FMMODFUNC void fm_comp_identity_destroy(fm_comp_def_cl, fm_ctx_def_t *);

const fm_comp_def_t fm_comp_identity = {"identity", &fm_comp_identity_gen, NULL,
                                        NULL};
