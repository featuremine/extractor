 ...
 * @date 7 Mar 2023
 * @brief File contains C definitions of the "skip_unless" logical operator object
 *
...
const fm_comp_def_t fm_comp_skip_unless = {"skip_unless", &fm_comp_skip_unless_gen,
