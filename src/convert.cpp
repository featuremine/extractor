...
fm_ctx_def_t *fm_comp_convert_gen(fm_comp_sys_t *csys, fm_comp_def_cl closure,
  ...
  using supported_conversions = fmc::type_list<
      ...
      pair<FIXEDPOINT128, FLOAT64>, pair<FLOAT64, FIXEDPOINT128>,
      pair<INT8, FIXEDPOINT128>, pair<INT16, FIXEDPOINT128>,
      pair<INT32, FIXEDPOINT128>, pair<FIXEDPOINT128, RPRICE>,
      pair<RPRICE, FIXEDPOINT128>, pair<FIXEDPOINT128, INT32>,
