...
if __name__ == "__main__":
    ...
    out_file_one = os.path.join(src_dir, "data/exp.test.csv")
    ...
    extr.assert_numdiff(os.path.join(src_dir, 'data/exp.base.csv'), os.path.join(src_dir, 'data/exp.test.csv'))
