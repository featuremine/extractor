...
if __name__ == "__main__":
    ...
    out_file_one = os.path.join(src_dir, "data/pow.test.csv")
    ...
    out_stream_one = op.pow(val_one, val_two)
    ...
    extr.assert_numdiff(os.path.join(src_dir, 'data/pow.base.csv'), os.path.join(src_dir, 'data/pow.test.csv'))
