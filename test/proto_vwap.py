...
if __name__ == "__main__":
    ...
    bar_file = os.path.join(src_dir, "data/bar_20171018_proto_vwap.test.csv")
    ...
    op.csv_record(bars[0], bar_file)

    graph.stream_ctx().run_to(New_York_time(2017, 10, 18, 16))

    extr.flush()

    extr.assert_numdiff(os.path.join(src_dir, 'data/bar_20171018_proto_vwap.base.csv'),
                        os.path.join(src_dir, 'data/bar_20171018_proto_vwap.test.csv'))
