...
if __name__ == "__main__":
    ...
    out_file_one = os.path.join(src_dir, "data/count.test.csv")
    ...
    extr.assert_base(os.path.join(src_dir, 'data/count.base.csv'), os.path.join(src_dir, 'data/count.test.csv'))
