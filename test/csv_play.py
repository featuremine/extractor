...
if __name__ == "__main__":
    ...
    data_in = graph.features.csv_play(src_dir + "/data/csv_play_file.csv",
                                      (("timestamp", extr.Time64, ""),
                                       ("val1", extr.Int32, ""),
                                          ("val2", extr.Uint16, ""),
                                          ("unicode", extr.Array(extr.Char, 30), "")), name="csv_play_0")
    data_out = graph.features.csv_record(data_in, src_dir +
                                         "/data/csv_play_file_py.test.csv", name="csv_record_0")
    ...
    extr.assert_base(src_dir + '/data/csv_play_file_py.base.csv',
                     src_dir + '/data/csv_play_file_py.test.csv')
