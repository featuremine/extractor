...
if __name__ == "__main__":
    ...
    assert_array_equal(add_pd["price"].values, [extr.FixedPoint128(val) for val in [0.2109375, 0.2109375, 0.2109375, 0.2109375, 0.2109375, 0.2109375]])
    assert_array_equal(add_pd["qty"].values, [extr.FixedPoint128(val) for val in [200, 250, 200, 200, 200, 200]])
    ...
    assert_array_equal(insrt_pd["price"].values, [extr.FixedPoint128(0.2109375)])
    assert_array_equal(insrt_pd["prio"].values, [5])
    assert_array_equal(insrt_pd["qty"].values, [extr.FixedPoint128(200)])
    ...
    assert_array_equal(pos_pd["price"].values, [extr.FixedPoint128(0.2109375)])
    assert_array_equal(pos_pd["qty"].values, [extr.FixedPoint128(200)])
    ...
    assert_array_equal(cancel_pd["price"].values, [extr.FixedPoint128(val) for val in [0.2109375, 0.2109375, 0.2109375]])
    assert_array_equal(cancel_pd["qty"].values, [extr.FixedPoint128(val) for val in [200, 200, 200]])
    ...
    assert_array_equal(execute_pd["price"].values, [extr.FixedPoint128(val) for val in [0.2109375, 0.2109375, 0.2109375, 0.2109375]])
    assert_array_equal(execute_pd["qty"].values, [extr.FixedPoint128(val) for val in [250, 200, 100, 50]])
    ...
    assert_array_equal(trade_pd["trade_price"].values, [extr.FixedPoint128(val) for val in [0.2109375, 0.2109375]])
    assert_array_equal(trade_pd["qty"].values, [extr.FixedPoint128(val) for val in [25, 25]])
    ...
    assert_array_equal(state_pd["price"].values, [extr.FixedPoint128(0.2109375)])
    ...
    assert_array_equal(set_pd["price"].values, [extr.FixedPoint128(0.2109375)])
    assert_array_equal(set_pd["qty"].values, [extr.FixedPoint128(100)])
