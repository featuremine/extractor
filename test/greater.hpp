 ...
 * @date 22 Aug 2018
 * @brief File contains tests for the "greater" logical operator feature
 *
...
TEST(greater_comp, multiple_field) {
  using namespace std;
  ...
  auto *comp_D =
      fm_comp_decl(sys, g, "csv_record", 1, cstr_t, comp_C,
                   (src_dir + "/data/greater_multiple.test.csv").c_str());
  ...
  EXPECT_BASE((src_dir + "/data/greater_multiple.base.csv").c_str(),
              (src_dir + "/data/greater_multiple.test.csv").c_str());
}

TEST(greater_comp, string_field) {
  using namespace std;
  ...
  cout << "Building greater" << endl;
  auto *comp_C =
      fm_comp_decl(sys, g, "greater", 2, greater_param_t, comp_B, comp_A);
  ASSERT_NE(comp_C, nullptr);
  cout << "Built greater" << endl;

  auto *comp_D =
      fm_comp_decl(sys, g, "csv_record", 1, cstr_t, comp_C,
                   (src_dir + "/data/greater_string.test.csv").c_str());
  ASSERT_NE(comp_D, nullptr);
  ...
  EXPECT_BASE((src_dir + "/data/greater_string.base.csv").c_str(),
              (src_dir + "/data/greater_string.test.csv").c_str());
}

TEST(greater_comp, single_field) {
  using namespace std;
  ...
  auto *comp_C =
      fm_comp_decl(sys, g, "greater", 2, greater_param_t, comp_BF, comp_AF);
  ASSERT_NE(comp_C, nullptr);

  auto *comp_D =
      fm_comp_decl(sys, g, "csv_record", 1, cstr_t, comp_C,
                   (src_dir + "/data/greater_single.test.csv").c_str());
  ASSERT_NE(comp_D, nullptr);
  ...
  EXPECT_BASE((src_dir + "/data/greater_single.base.csv").c_str(),
              (src_dir + "/data/greater_single.test.csv").c_str());
}
